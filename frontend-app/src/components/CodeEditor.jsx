...
const CodeEditor = ({ code, onChange, theme = "dark", onCursorChange }) => {
  ...
  const handleEditorBeforeMount = (monaco) => {
    monaco.editor.defineTheme("jvoid-dark", {
      ...
      inherit: true,
      rules: [
        { token: "comment", foreground: "6d6e7a", fontStyle: "italic" },
