            ...
            <div className="header-controls">
                ...
                <div className="help-container">
                    <div className="tooltip-text">
                        ...
                        <div className="tooltip-note">J-Void contains the exact same 95 curated questions as Shreyan's Arc—tailored for Freshers, SDE 1, and Junior Developer roles.</div>
                        <a
